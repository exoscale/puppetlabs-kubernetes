...
class kubernetes (
  ...
  Optional[String] $etcd_servers                                   = $kubernetes::params::etcd_servers,
  Optional[String] $etcd_prefix                                    = $kubernetes::params::etcd_prefix,
  Optional[String] $etcd_cafile                                    = $kubernetes::params::etcd_cafile,
  Optional[String] $etcd_certfile                                  = $kubernetes::params::etcd_certfile,
  Optional[String] $etcd_keyfile                                   = $kubernetes::params::etcd_keyfile,
